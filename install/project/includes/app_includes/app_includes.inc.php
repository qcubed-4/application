<?php
    /*
     * =============================================
     * PREPARING YOUR CUSTOM CLASSES FOR AUTOLOADING
     * =============================================
     * This file is run everytime the framework initializes
     * (i.e. on each page access or in any file where you include prepend.inc.php or qcubed.inc.php)
     *
     ...
     * -------
     *
     * In case you want to run some custom code on each page access (such as counting the number of hits etc.),
