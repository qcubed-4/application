<?php
     ...
     * to support running on two different web servers with the same data backends or with load balancing.
     * If you are using SessionHandler, it also automatically centralizes your formstates.
     *
     * To avail this feature, you must have a dedicated table in one of your databases above.
     * The table must have 3 columns with the following names and datatypes (note that column names should match exactly):
     *
     * [Column 1]
     *      Name = id
     ...
     * 1. The DB CONNECTION index (repeat: the numerical index) of the database from the list of databases above
