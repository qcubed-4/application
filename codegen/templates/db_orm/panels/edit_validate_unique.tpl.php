...
?>
    /**
    * Validates the current input fields for uniqueness and displays warnings if duplicates are found.
    *
    * @return bool True if the validation passes without duplicates; false otherwise.
    * @throws Caller
    * @throws InvalidCast
    */
