...
Once installed, you should install the qcubed-4/app-starter project by executing the following at the command line:

~~~
php composer.phar create-project qcubed-4/app-starter your_dir_name
~~~
...
~~~
composer create-project qcubed-4/app-starter your_dir_name
~~~

If you wish to be a contributor to QCubed-4 and you would like to submit enhancements or bug fixes, you should add the "-sDev" flag to the end of the command line above. This will cause Composer to include a git repository with your checkout that will track the changes you make to the core of QCubed-4, and make it easier for you to enter pull requests on GitHub.
...
Note that by default, this is already setup for you in most files (actually, almost every file that you get with QCubed-4, or the ones that QCubed generates).

To change this or for any new PHP scripts you want to write, simply make sure any PHP script that wants to utilize the QCubed-4 Framework STARTS with:
