<?php
     ...
     * SpinnerGen class and QCubed. This file is part of the core and will be overwritten
     * when you update QCubed. To override, make your changes to the Spinner.php file in
     * the controls folder instead.
     *
     * A spinner object is a field that is accompanied by up/down arrows to allow numeric or
     * numeric like values to be quickly selected. You can specify how the arrows step
     ...
     * @package QCubed\Jqui
     */
    class SpinnerBase extends SpinnerGen
    {
    }
