<?php
    ...
    use QCubed\Jqui\Event\AutocompleteSource;
    use QCubed\Js\Closure;
    use QCubed\Js\VarName;
    ...
    class AutocompleteBase extends AutocompleteGen
    {
         ...
         */
        const string FILTER_CONTAINS = 'return $j.ui.autocomplete.escapeRegex(term);'; // this is the default filter
        /**
         ...
         * @see QAutocomplete::UseFilter
         */
        const string FILTER_STARTS_WITH = 'return ("^" + $j.ui.autocomplete.escapeRegex(term));';
         ...
         * @param null|ControlBase $objParentControl The parent control on which the action is to be bound
         *
         * @throws Caller
         */
        public function setDataBinder(string $strMethodName, mixed $objParentControl = null): void
        {
            if ($objParentControl) {
                $objAction = new AjaxControl($objParentControl, $strMethodName, 'default', null, 'ui');
            } else {
                $objAction = new Ajax($strMethodName, 'default', null, 'ui');
            }
            $this->addAction(new AutocompleteSource(), $objAction);

            $this->mixSource = new VarName('qcubed.acSourceFunction');
