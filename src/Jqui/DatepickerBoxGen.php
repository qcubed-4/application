<?php
    ...
    /**
     * Class DatepickerBoxGen
     *
     * This is the DatepickerBoxGen class that is automatically generated
     * by scraping the JQuery UI documentation website. As such, it includes all the options
     * as listed by the JQuery UI website, which may or may not be appropriate for QCubed. See
     * the DatepickerBoxBase class for any glue code to make this class more
     * usable in QCubed.
     *
    ...
    class DatepickerBoxGen extends TextBox
    {
         ...
         *
         * @param mixed $date The date or configuration for the dialog to display.
         * @param callable|null $onSelect An optional callback executed when an item is selected.
         * @param array|null $options Additional options to configure the dialog behavior.
         * @param mixed|null $pos The position information for displaying the dialog.
         * @return void
         */
        public function dialog(mixed $date, ?callable $onSelect = null, ?array $options = null, mixed $pos = null): void
        {
        ...
        public static function getModelConnectorParams(): array
        {
            return array_merge(parent::GetModelConnectorParams(), array(
                ...
                new QModelConnectorParam (get_called_class(), 'AutoSize', 'Set to true to automatically resize the input field to accommodate dates in the current dateFormat.', Type::BOOLEAN),
                new QModelConnectorParam (get_called_class(), 'ButtonImage', 'A URL of an image to use to display the datepicker when the show On option is set to \"button\" or \"both\". If set, the buttonText option becomes the alt value and is not directly displayed.', Type::STRING),
                ...
                new QModelConnectorParam (get_called_class(), 'DayNamesMin', 'The list of minimised day names, starting from Sunday, for use as column headers within the datepicker.', Type::ARRAY_TYPE),
                new QModelConnectorParam (get_called_class(), 'DayNamesShort', 'The list of abbreviated day names, starting from Sunday, for use as requested via the dateFormat option.', Type::ARRAY_TYPE),
                ...
                new QModelConnectorParam (get_called_class(), 'MonthNames', 'The list of full month names, for use as requested via the date Formation.', Type::ARRAY_TYPE),
                ...
                new QModelConnectorParam (get_called_class(), 'SelectOtherMonths', 'Whether days in other months shown before or after the current month are selectable. This only applies if the showOtherMonths option is set to true.', Type::BOOLEAN),
                ...
                new QModelConnectorParam (get_called_class(), 'ShowButtonPanel', 'Whether to display a button pane underneath the calendar. The button pane contains two buttons, a Today button that links to the current day, and a Done button that closes the datepicker. The button text can be customized using the currentText and closeText option respectively.', Type::BOOLEAN),
                ...
                new QModelConnectorParam (get_called_class(), 'YearRange', 'The range of years displayed in the year drops-down: either relative to today\'s year (\"-nn:+nn\"), relative to the currently selected year(\"c-nn:c+nn\"), absolute (\"nnnn:nnnn\"), or combinations of these formats (\"nnnn:-nn\"). Note that this option only affects what appears in the drop-down, to restrict which dates may be selected use the minDate and/or maxDate options.', Type::STRING),
