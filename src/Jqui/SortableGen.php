<?php
    ...
    class SortableGen extends Panel
    {
        ...
        /**
         * Magic method to retrieve the value of a dynamically accessible property.
         *
        ...
        /**
         * Sets the value of a dynamic property and updates the corresponding widget option if applicable.
         *
         * This method allows you to set properties dynamically. If the property corresponds
         * to a known widget option, it updates the widget's state using the appropriate
         * setup function. Type checking and casting are applied where necessary.
         * If the property does not match any recognized option, it falls back to the parent implementation.
         *
         * @param string $strName The name of the property to set.
         * @param mixed $mixValue The value to assign to the property. May be subject to type casting
         *                        based on the property being set.
         *
         * @return void
         * @throws InvalidCast If the value cannot be cast to the required type for the given property.
         * @throws Caller If an unknown property is being set and the parent implementation does not recognize it.
         * @throws \Exception
         */
