<?php
     ...
     * calls to develop an authorization and authentication module for QCubed, but it's very difficult to come up with a
    ...
    class AuthBase
    {
         ...
         * @return void
         */
        public static function checkRemoteAdmin(): void
        {
            ...
            header($_SERVER['SERVER_PROTOCOL'] . ' 401 Accesses Denied');
         ...
         * @return bool
         */
        public static function isRemoteAdminSession(): bool
        {
            // Allow Remote?
        ...
        /**
         * @deprecated. This is a temporary stub for backwards compatibility
         *
         * @param $ip
         * @param $range
         * @return bool
         ...
         * @param string $range the IP number range. The range could be in 'IP/mask' or 'IP - IP' format. Mask could be simple
