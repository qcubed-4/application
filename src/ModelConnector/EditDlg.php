<?php
    ...
    class EditDlg extends QDialog
    {
        ...
        /**
         * Constructs a new instance of the class, initializing default settings and creating the necessary components.
         *
         * @param FormBase|ControlBase $objParentObject The parent object (either a form or a control) for the current
         *     instance.
         * @param string|null $strControlId An optional control ID to assign to the current instance.
         *
         * @return void
         * @throws Caller
         */
