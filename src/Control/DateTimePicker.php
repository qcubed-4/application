<?php
    ...
    class DateTimePicker extends Q\Project\Control\ControlBase
    {
         ...
         *
         */
        public const string SHOW_DATE = 'Date';
        public const string SHOW_DATE_TIME = 'DateTime';

        public const string SHOW_DATE_TIME_SECONDS = 'DateTimeSeconds';
        public const string SHOW_TIME = 'Time';
        public const string SHOW_TIME_SECONDS = 'TimeSeconds';

        public const string MONTH_DAY_YEAR = 'MonthDayYear';
        public const string DAY_MONTH_YEAR = 'DayMonthYear';
        public const string YEAR_MONTH_DAY = 'YearMonthDay';
         ...
         *
         * @return \QCubed\Codegen\Generator\DateTimePicker
         */
