<?php
     ...
     * @was QControlBase
     */
    abstract class ControlBase extends HtmlAttributeManager
    {

        public const string COMMENT_START = 'Begin';
        public const string COMMENT_END = 'End';
        ...
        public const bool CAUSES_VALIDATION_NONE = false;
        public const bool CAUSES_VALIDATION_ALL = true;
        public const int CAUSES_VALIDATION_SIBLINGS_AND_CHILDREN = 2;
        public const int CAUSES_VALIDATION_SIBLINGS_ONLY = 3;

        public const string ACTION_PARAM = 'Param';
        public const string ACTION_ORIGINAL_PARAM = 'OriginalParam';
        public const string ACTION_OBJ = 'Action';
        public const string ACTION_CONTROL_ID = 'ControlId';
        public const string ACTION_FORM_ID = 'FormId'; // This not really used. It is here in the event we ever support more than one form on a page.
