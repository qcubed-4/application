<?php
     ...
     */
    abstract class TextBoxBase extends ControlBase
    {
        // Text modes
        public const string SINGLE_LINE = 'text'; // Single line text inputs INPUT type="text" boxes
        public const string MULTI_LINE = 'MultiLine'; // Textarea
        public const string PASSWORD = 'password'; //Single-line password inputs
        ...
        public function __get(string $strName): mixed
        {
            switch ($strName) {
                ...
                case 'Value': return empty($this->strText) ? '' : $this->strText;
