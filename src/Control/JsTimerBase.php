<?php
     ...
     */
    class JsTimerBase extends ControlBase
    {
         ...
         *
         * @param EventBase $objEvent has to be an instance of QTimerExpiredEvent
         * @param ActionBase $objAction Only a QTimerExpiredEvent can be added,
         *                                         but multiple Actions using the same event are possible!
         *
         * @return void
         * @throws \QCubed\Exception\Caller
         */
        public function addAction(EventBase $objEvent, ActionBase $objAction): void
        {
            if (!($objEvent instanceof TimerExpired)) {
        ...
        {
            if (($strEventName == TimerExpired::EVENT_NAME && !$this->blnPeriodic) &&
                (($strActionClass == '\QCubed\Action\Ajax' && Application::isAjax()) ||
                    ($strActionClass == '\QCubed\Action\Server' && Application::instance()->context()->requestMode() == Context::REQUEST_MODE_QCUBED_SERVER))
            ) {
        ...
        {
            if (Application::instance()->context()->requestMode() == Context::REQUEST_MODE_QCUBED_SERVER) {
