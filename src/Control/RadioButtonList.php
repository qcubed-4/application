<?php
    ...
    {
        const int BUTTON_MODE_NONE = 0;
        const int BUTTON_MODE_JQ = 1;
        const int BUTTON_MODE_SET = 2;
        const int BUTTON_MODE_LIST = 3;    // just a vanilla list of radio buttons with no row or column styling
        ...
        /**
         * Parses incoming POST data for the control and updates its state accordingly.
         * Processes the value of the control from the form submission, unselecting all items if no value is found,
         * or selecting items by their index if a value is present.
         * @return void
         * @throws Caller
        ...
        /**
         * Creates a jQuery UI widget for the control based on the button mode.
         * It configures the widget as either a button set or individual buttons depending on the mode set.
         *
         * @return void
         * @throws Caller
         */
        public function makeJqWidget(): void
        {
            ...
            if ($this->intButtonMode == self::BUTTON_MODE_SET) {
                ...
                Application::executeSelectorFunction(["input:radio", "#" . $ctrlId], 'button', ApplicationBase::PRIORITY_HIGH);
            }
        }
        ...
        /**
         * Generates the HTML output for the control based on the button mode, layout, and other settings.
         *
         * If no items are present, it returns an empty string. Depending on the button mode or column
         * configuration, it renders the buttons as a set, a single column, or a table. Optionally, if a
         * maximum height is specified, it wraps the rendered content within a scrollable container.
         *
        ...
        /**
         * Validates the current selection based on whether the selection is required.
         * If the selection is required and no option is selected, validation fails and a validation error message is set.
         *
         ...
         * @throws Caller If the property does not exist in the current class and cannot be resolved by the
         *     parent::__get method.
         * @throws \Exception
         */
         ...
         * @param mixed $mixValue Value to assign to the property.
         *
         * @return void
         *
         * @throws InvalidCast If the value cannot be cast to the expected type.
         * @throws Caller If the property name does not exist or is invalid.
         * @throws \Exception
         */
