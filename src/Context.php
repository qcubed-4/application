<?php
    ...
    class Context
    {
        ...
        public function pathInfo(): string
        {
            if (!$this->strPathInfo) {
                ...
                if (isset($_SERVER['REQUEST_URI'])) {
                    ...
                    // Remove the script name and query string to get only the PATH part
        ...
        /**
         * Gets the value of the PathInfo item at an index $intIndex.  Will return null if it doesn't exist.
         *
                ...
                if (str_contains($strUserAgent, 'msie')) {
                    ...
                    if (str_contains($strUserAgent, 'trident')) {
                        ...
                        elseif (str_contains($strUserAgent, 'konqueror')) {
                            ...
                            // only looking at the major version number on this one
                            $matches = array();
