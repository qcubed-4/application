<?php
    ...
    abstract class Html {
        ...
        const string SMB = 'smb://';

        // Font Families
        const string FONT_FAMILY_ARIAL = 'Arial, Helvetica, sans-serif';
        const string FONT_FAMILY_HELVETICA = 'Helvetica, Arial, sans-serif';
        const string FONT_FAMILY_TAHOMA = 'Tahoma, Arial, Helvetica, sans-serif';
        const string FONT_FAMILY_TREBUCHET_MS = "'Trebuchet MS', Arial, Helvetica, sans-serif";
        const string FONT_FAMILY_VERDANA = 'Verdana, Arial, Helvetica, sans-serif';
        const string FONT_FAMILY_TIMES_NEW_ROMAN = "'Times New Roman', Times, serif";
        const string FONT_FAMILY_GEORGIA = "Georgia, 'Times New Roman', Times, serif";
        const string FONT_FAMILY_LUCIDA_CONSOLE = "'Lucida Console', 'Courier New', Courier, monospaced";
        const string FONT_FAMILY_COURIER_NEW = "'Courier New', Courier, monospaced";
        const string FONT_FAMILY_COURIER = 'Courier, monospaced';

        const string TEXT_ALIGN_LEFT = "left";
        const string TEXT_ALIGN_RIGHT = "right";

        // type property for ordered lists
        const string OL_NUMBERS = '1';
        const string OL_UPPERCASE_LETTERS = 'A';
        const string OL_LOWERCASE_LETTERS = 'a';
        const string OL_UPPERCASE_ROMAN = 'I';
        const string OL_LOWERCASE_ROMAN = 'i';

        // list-style-type property for an unordered list
        const string UL_DISC = 'disc';
        const string UL_CIRCLE = 'circle';
        const string UL_SQUARE = 'square';
        const string UL_NONE = 'none';

        /**
         * Contains/Defines Overflow CSS Styles to be used on QControls
         */
        const string OVERFLOW_NOT_SET = 'NotSet';
        const string OVERFLOW_AUTO = 'auto';
        const string OVERFLOW_HIDDEN = 'hidden';
        const string OVERFLOW_SCROLL = 'scroll';
        const string OVERFLOW_VISIBLE = 'visible';
         ...
         *
         * @param null|string $strClassList The current list of CSS class names, passed by reference.
