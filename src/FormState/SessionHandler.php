<?php
    ...
    {
        const string SESSION_KEY = 'qformstate';
         ...
         *
         * @param string $strPostDataState The encoded state string containing the reference to the serialized form
         *     data.
         *
         * @return string|null Returns the serialized form data as a string or null if the data cannot be retrieved or
         *     is invalid.
         * @throws Cryptography
         * *@throws \Exception
         */
