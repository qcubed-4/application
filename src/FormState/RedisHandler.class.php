<?php
    ...
    class RedisHandler extends ObjectBase
    {
         ...
         * @throws Exception
         */
        public static function Save(string $strFormState, bool $blnBackButtonFlag)
        {
            ...
            if (
                ...
                try {
                    $crypt = new Cryptography(__REDIS_BACKED_FORM_STATE_HANDLER_ENCRYPTION_KEY__, false, null,
        ...
        /**
         * Load the formstate from the data store
         *
