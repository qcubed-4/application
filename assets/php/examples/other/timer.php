...
<div id="instructions" xmlns="http://www.w3.org/1999/html">
    <h1>Measuring Performance using Timer</h1>

    <p>If you ever need to do light-weight profiling of your QCubed-4 application,
    ...
    <p>Each of the timers is internally maintained as a Timer object. If you want to
        know more about the timers - for example, the number of times the timer was
        started—you can get the Timer object instance and then be interrogating that
        instance:<br>
