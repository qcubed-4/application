...
class ExamplesForm extends FormBase
{
    ...
    protected ?ProjectList $dtgProjects = null;
    protected Proxy $pxyExample;
    protected ?iCondition $objAdditionalConditions = null;
    protected ?array $objAdditionalClauses = null;
    ...
    protected function formCreate(): void
    {
        ...
        // to create, define and set up the various columns that WE choose, in the order
        // that WE want.
    ...
    public function getUserNameCellParams(Project $item): array
    {
        return [
    ...
    public function defaultDataBinder(): void
    {
    ...
    {
        Application::displayAlert('Pretending to edit Project #' . $strParameter);
    }
}
