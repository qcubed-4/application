...
<div id="instructions" class="full">
	...
	<p>There is a school of security thought that suggests that files that aren't meant to
		...
		like this may seem to be overzealous for some, but for others - especially those who
		had their sites hacked in the past - will immediately understand the benefits.</p>

	<p>All QCubed-4 non-web-accessible files - including those of the plugins - are under /includes
		a folder. QCubed has been architected with security in mind; you can easily move the ENTIRE
	...
	<p>There's another reason why you may want to move your /includes folder outside of the
		web application: if you want to share a QCubed-4 installation between two web applications.
		If that's the case, just follow the instructions above; you'll need to carefully juggle the
		database configuration settings and such, but if you're sharing the installation for a few apps, you
		probably know what you're doing :-). If you have any questions along the way,
		<a href="https://github.com/qcubed-4/application/issues">QCubed-4 Forums</a> are there to help.</p>
</div>
