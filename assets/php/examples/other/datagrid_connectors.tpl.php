...
<?php $this->renderBegin(); ?>
	...
	<div id="instructions">
		...
		<p>Using simple string properties or more complex (and more powerful) <strong>QCubed-4 Query Nodes</strong>, you can
		...
		<p>It even comes with its own <strong>dataBinder()</strong>, and the list connector is already set up to use that
			...
			this example, we'll only show projects whose status is "open." Clauses such as expanding can also easily
