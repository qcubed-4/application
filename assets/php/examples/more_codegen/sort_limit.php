...
<div id="instructions">
	...
	<strong>QCubed-4 Query Clause Array</strong> parameter, where you can specify a <strong>Clause</strong>
	object, including functionality that handles <strong>ORDER BY</strong>, <strong>LIMIT</strong>
	...
	in any number of QCubed-4 Query Node columns, followed by an optional boolean (to specify ascending/descending),
    ...
    <p>For more information about "QQ::"-related classes (a.k.a. <strong>QCubed-4 Query</strong>), please refer to section 3 of the
        Example Site.</p>
</div>
