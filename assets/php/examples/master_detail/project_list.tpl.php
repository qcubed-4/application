...
<div id="instructions">
	...
	<p>Moreover, you can enable inline editing for any of these datagrids—as demonstrated in the example below
	...
	<ul>
		<li>Master DataGrid for the Project should go on the FORM.</li>
