...
<div id="instructions">
    ...
    Alternatively, developers may wish to utilize external JavaScript libraries like Dojo, Yahoo! YUI, etc.
    to create their own set of Controls.</p>

    <p>Whatever the case may be, QCubed-4 makes it easy to implement custom controls, complete with JavaScript
    ...
    <p>If possible, subclass your custom controls from similar controls in the core that are already created.
        ...
        that is installable using Composer and that is easily shared with other developers.</p>
</div>
