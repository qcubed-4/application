...
<div id="instructions">
    <h1>JsTimer - QCubed-4 JavaScript Timer</h1>
    ...
    on your timer instance. You can restart the timer by simply calling <strong>->start($intNewTime)</strong>. Without a parameter,
