...
<div id="instructions">
    ...
    <p>The order in which block controls are rendered is:</p>
	<ul>
	...
	a <strong>Text</strong> value and also set up a <strong>Template</strong>.  Finally, we render that entire panel out (complete
