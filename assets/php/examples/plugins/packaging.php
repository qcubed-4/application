...
<div id="instructions" class="full">
    ...
    <p>You may see some or all of the following directories in a QCubed-4 library:</p>
    <ul>
        <li><strong>src—</strong> PHP source code. This will be pointed to by the composer.json a file included with the library. You may see the following
            here:
            <ul>
                <li>A "Gen" file, which often is actually generated by creating a php program that will scrape
                    ...
                    are created. This file essentially represents the exposing of the raw functionality of the widget to QCubed-4.</li>
                <li>A "Base" file, which overrides the Gen file and contains code to more elegantly interface the raw widget
                    interface with the way QCubed-4 handles controls.</li>
            </ul>
        </li>
        ...
        <li><strong>install</strong> - These are files that get moved out of the vendor directory after installation IF they do not
            ...
            If the file already exists in the location indicated, it will not be overwritten.
        </li>
        <li><strong>tools</strong> - Command line tools and other support files. For example, if some of your control is automatically
            generated from scraped web pages, like our implementation of the JQuery UI library, place the scraper source code here
	...
	<p>Include a <strong>composer.json</strong> file in the root directory of your control. It's probably easiest to copy
	...
	<p>Once you are ready to give it to the community, post an issue on the <a href="https://github.com/qcubed-4/application">QCubed-4 GitHub website</a>.
        One of the core developers will take a look and add it to our list of known libraries to install. Generally,
        we will not move these controls to the QCubed-4 repository, but we will point people to your repo so that you
        can continue to maintain your QCubed-4 library.
    </p>
</div>
