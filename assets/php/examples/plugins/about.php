...
<div id="instructions" class="full">
	...
	<p>QCubed-4 was built on the principle that the core distribution should be
	...
	<p>The current library architecture relies on <a href="http://getcomposer.org">Composer</a> for installation.
		...
		matter of executing the Composer "require" command. For example, to install the QCubed-4 Bootstrap library,
    ...
    <p>Once a library is installed, you can use Composer to
		monitor for updates to the libraries and automatically install those updates. Simply execute
           <code>composer update</code> and all your libraries will be updated.
		See the <a href="https://www.github.com/qcubed-4" target="_blank">QCubed-4 GitHub</a> page for a
		list of composer-installable libraries.
    </p>
	...
	<p>Composer installs all files in a <strong>/vendor</strong> directory. It includes an autoloader,
		...
		need to use <strong>include</strong> statements to include them.
    </p>

	<p>QCubed-4 includes a <a
			href="../../../../tools/plugin_manager.php">Library Manager</a>
