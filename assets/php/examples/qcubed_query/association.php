...
<div id="instructions">
    <h1>QQuery-4 and Association Tables (Many-to-Many Relationships)</h1>
    ...
    <p>Naming standards for the many-to-many relationship are the same as the naming standards for the public methods
        ...
        retrieve an array of Project objects that are associated with this Person object as a "Team Member",
    ...
    <p>More importantly, when performing <strong>QCubed-4 Queries</strong> across association tables, we can <strong>Expand</strong> on the many-to-many
