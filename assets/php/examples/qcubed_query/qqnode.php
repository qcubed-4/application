...
<div id="instructions" class="full">
	...
	<p><strong>Node</strong> objects represent entities that can be used to select or filter rows in SQL queries.
        ...
        <strong>Node</strong> classes for your data model are generated for you during the code generation process.</p>
	...
	for the type of object you want as the result of your query (e.g., "Person").
