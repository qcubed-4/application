...
<?php require('../includes/header.inc.php'); ?>
	...
	<div id="instructions">
		...
		<p>All three QCubed-4 Query methods expect two parameters, a <strong>Condition</strong> and an optional set of <strong>Clauses</strong>.
		...
		<p>Notice that <strong>QCubed-4 Query</strong> doesn't have any construct to describe what would normally be your SELECT clause.
		This is because we take advantage of the code generation process to allow <strong>QQuery</strong> to automatically "know" which
		fields that should be SELECT-ed based on the query, conditions and clauses you are performing.  This will allow a lot
		greater flexibility in your data model. Because the framework is now taking care of column names, etc., instead of the
