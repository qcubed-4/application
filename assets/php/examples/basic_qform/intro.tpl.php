<?php
// This is the HTML template include file for an intro.php (View Layer)
...
<div id="instructions">
	...
	<p>All <strong>Form</strong> objects use an HTML include a file—in this case, we define the HTML in
