...
<div id="instructions">
	...
	<p>When you clicked on the button in the previous example, the HTML form posted its information back to itself.  However,
        ...
        are stateful objects that maintain state from one post to the next. QCubed-4
    does this by serializing the entire form object, together with all its controls and subcontrols, into one
    long string and saving this information. This is known as <strong>formstate</strong></p>. Before QCubed-4 reads the
    ...
    <p>
        ...
        but it is not secure and has some performance and size limitations. Fortunately, QCubed-4 provides you with a number of
