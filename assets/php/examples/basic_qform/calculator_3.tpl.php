...
<div id="instructions">
	...
	<p>In our final Calculator example, we show how you can use custom renderers to affect layout,
		as well as use control properties to change the appearance of your Controls.</p>

	<p>The QCubed-4 distribution includes a sample custom renderer, <strong>renderWithName()</strong>, which is
	...
	<p>Note how "Value 1" and "Value 2" are in all caps and boldfaced, while "Operation" is not.  This is
		...
		<strong>renderWithName()</strong> method has code which will boldface/all caps the names of any required controls.</p>
	...
	<p>And finally, in our HTML template, we are now using the <strong>renderWithName()</strong> calls.  Because of that,
		we no longer need to code the "Value 1" and "Value 2" HTML in the template.</p>
</div>
