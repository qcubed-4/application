    ...
    <div id="instructions">
        ...
        <ul>
            ...
            <li><strong>$tagAttributes</strong>: If given, a key/value array that becomes attributes for the anchor or button tag.
                This could be used to specify a class, id, or data-attribute. As above, it can be extracted from the data itself.</li>
        ...
        <p>In the example, the first column has a link column that you click on, and the second column is a link that you hover over.
            The first column goes to the same page you are viewing but adds a GET variable to the URL, detects it, and puts
            a message at the bottom of the table depending on what line you clicked on. The second column uses a Proxy
