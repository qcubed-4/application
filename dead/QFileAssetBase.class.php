 ...
 */
class FileAssetBase extends Panel
{
    public $imgFileIcon;
    public $btnDelete;
    public $btnUpload;
    ...
    public function __construct($objParentObject, $strControlId = null)
    {
        ...
        $this->dlgFileAsset = new FileAssetDialog($this, 'dlgFileAsset_Upload');
    ...
    public function dlgFileAsset_Upload()
    {
        ...
        if (!file_exists($this->dlgFileAsset->flcFileAsset->File) || !$this->dlgFileAsset->flcFileAsset->Size) {
            ...
            if (is_array($this->strAcceptibleMimeArray) && (!array_key_exists($this->dlgFileAsset->flcFileAsset->Type,
                ...
                $this->strRandomFileName = basename($this->dlgFileAsset->flcFileAsset->File) . rand(1000,
                        9999) . '.' . $strExtension;
